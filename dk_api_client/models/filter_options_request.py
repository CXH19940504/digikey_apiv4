...
class SortOptions(object):
    ...
    def __init__(self, field=None, sort_order=None, _configuration=None):  # noqa: E501
    ...
    @property
    def field(self):
        """Gets the field of this .  # noqa: E501
    ...
    def field(self, field):
        ...
        allowed_values = [
            ...
            "PriceManufacturerStandardPackage"]  # noqa: E501
        if self._configuration.client_side_validation and field not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid values for `field` {0}, must be a member of [{1}]"  # noqa: E501
                .format(field, ", ".join(map(str, allowed_values)))
            )

    @property
    def sort_order(self):
        """Gets the sort_order of this .  # noqa: E501
    ...
    def sort_order(self, sort_order):
        ...
        if self._configuration.client_side_validation and sort_order not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid values for `field` {0}, must be a member of [{1}]"  # noqa: E501
                .format(sort_order, ", ".join(map(str, allowed_values)))
            )
        self._sort_order = sort_order
